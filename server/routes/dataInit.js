...
// Reset All Data
// '/users/reset/alldata'
router.route("/reset/alldata").post(passDBConnection, (req, res, next) => {
    // Update Users
    ...
    return (
        req.db.db
            ...
            .then((n) => {
                if (n !== data.length) {
                    throw (
                        "Data Reset Error. Final Count Does Not Match in " +
                        collectionName +
                        " Collection."
                    );
                }
...
function users() {
    return [
        {
            _id: ObjectId("60983697a6183f2328fedf93"),
            username: "Bipin",
            name: "Bipin Regmi",
            ...
            password:
                "$2a$12$/moup.44KSmffBBg9lQnM.b41qnKA81tOJKb4v1Gl5kPaw.dtPvCe",
        },
    ];
}
